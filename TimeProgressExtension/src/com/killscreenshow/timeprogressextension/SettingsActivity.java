...
public class SettingsActivity extends PreferenceActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        //getActionBar().setIcon(R.drawable.ic_tp_icon);
    ...
    private void setupSimplePreferencesScreen() {
        ...
        bindPreferenceSummaryToValue(findPreference(TimeProgressExtension.PREF_START));
        bindPreferenceSummaryToValue(findPreference(TimeProgressExtension.PREF_END));
        bindPreferenceSummaryToValue(findPreference(TimeProgressExtension.PREF_TITLE));
    }
